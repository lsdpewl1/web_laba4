  ...
  <nav class="py-2 fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="#" class="nav-link px-2">Преимущества</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Прайс-лист</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Вопрос-ответ</a></li>
